...
from func.spacegroup import get_spacegroup
from func.read_tabind import read_indicator_table
...
3. If one has the mp_id and icsd_ids, i.e., the id of materials project website and ICSD database, 
...
def collect_data(home_path):
    ...
    data = {'formula': None, 'elements': None, 'elements_num': None, 'nelem': None, 'mp_id': None, 'icsd_ids': None,
            ...
            'soc_topo_class': None, 'soc_ind_class': None, 'soc_sym_ind': None, 'soc_inv_table': None, 
            ...
            'nsoc_topo_class': None, 'nsoc_ind_class': None, 'nsoc_sym_ind': None, 
    ...
    data['elements'] = poscar_data['elem']
    ...
    gid = poscar_data['spacegroup']
    data['spacegroup'] = get_spacegroup(gid)
   #data['poscar_str'] = poscar_data['poscar_str'] 
    ...
    data['mp_id'], data['icsd_ids'] = read_mp_icsd_id(home_path)
    ...
    if os.path.exists(wave_soc_path):
        ...
        data['soc_topo_class'], data['soc_ind_class'], data['soc_sym_ind'] = symtopo_data['topo_class'], symtopo_data['ind_group'], symtopo_data['sym_ind']
        ...
        if data['soc_topo_class'] == 'TCI':
            data['soc_inv_table'] = read_indicator_table(gid, data['soc_sym_ind'])
    ...
    if os.path.exists(wave_nsoc_path):
        ...
        data['nsoc_topo_class'], data['nsoc_ind_class'], data['nsoc_sym_ind'] = symtopo_data['topo_class'], symtopo_data['ind_group'], symtopo_data['sym_ind']
